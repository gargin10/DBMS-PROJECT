...
<body>
	...
	<div >
				...
				<tr>
					...
					<th style="width:100px;border-top:0px;">Cancel</th>
				...
				<tr class="text-error">
					...
					<th style="border-top:0px;"> <a href="delete.php?Tnumber=<?php echo $row['Tnumber']; ?>& doj= <?php echo $row['doj']; ?> & Name=<?php echo $row['Name']; ?>&Age=<?php echo $row['Age']; ?>& Sex=<?php echo $row['Sex']; ?> & Status=<?php echo $row['Status']; ?>&DOB=<?php echo $row['DOB']; ?> & class=<?php echo $class; ?>" >Cancel </a> </th>
