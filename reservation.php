		...
		<!-- display train -->
			<div class="span8 well">
				...
				<tr>
                    ...
                    <th style="width:150px;border-top:0px;"> Class </th>
				</tr>
				</table>
				</div>
 ...
 $m =$t % 60;
				...
				<tr class="text-error">
					...
					<td style="width:200px;">  
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "1A";?>"><b>1A</b></a> 
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "2A";?>"><b>2A</b></a>
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "3A";?>"><b>3A</b></a>
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "AC";?>"><b>AC</b></a> 
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>>&class=<?php echo "CC";?>"><b>CC</b></a> 
						<a class="text-error" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "SL";?>"><b>SL</b></a> 
				...
				<tr class="text-info">
					...
					<td style="width:65px;"> <?php   echo $h; ?>hrs<?php echo $m;?>min </td>
					<td style="width:200px;">
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "1A";?>"><b>1A</b> </a> 
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "2A";?>"><b>2A</b></a>
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "3A";?>"><b>3A</b></a>
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "AC";?>"><b>AC</b></a>
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>?>&class=<?php echo "CC";?>"><b>CC</b></a>
						<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&class=<?php echo "SL";?>"><b>SL</b></a>
					</td>
				</tr>
				<?php  
					}
